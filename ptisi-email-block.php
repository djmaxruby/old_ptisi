	...
	<div class="modal-dialog" role="document">
    	<div class="modal-content">
    		<div class="modal-header">
        		...
        		<h4 class="modal-title" id="myModalLabel"><?php echo $email_window[$global_lang]['title']; ?></h4>
      		</div>
    		<div class="modal-body">

					<div class="form-group">
				 	    <label for="input_name" class="col-sm-2 control-label"><?php echo $email_window[$global_lang]['name']; ?></label>
				 	    <div class="col-sm-10">
					...
					<div class="form-group">
				 	...
				 	<div class="form-group">
				    	<label for="input_subject" class="col-sm-2 control-label"><?php echo $email_window[$global_lang]['subject']; ?></label>
				    	<div class="col-sm-10">
				    		<input type="text" class="form-control" id="input_subject" name="input_subject" placeholder="Subject">
				    	</div>
					</div>
					<div class="form-group">
				    	<label for="input_subject" class="col-sm-2 control-label"><?php echo $email_window[$global_lang]['message']; ?></label>
				    	<div class="col-sm-10">
    		...
    		<div class="modal-footer">
        		<button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $email_window[$global_lang]['cancel']; ?></button>
        		<input type="submit" class="btn btn-primary" type="submit" value="<?php echo $email_window[$global_lang]['send']; ?>">
    		</div>
   		</div>
	</div>
